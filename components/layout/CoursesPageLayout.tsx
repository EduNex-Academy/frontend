...
import { mockCourses, categories, learningPaths } from "@/data/mock-data"
...
export function CoursesPageLayout({ userRole, initialQuery = '' }: CoursesPageLayoutProps) {
    ...
    const [selectedLearningPath, setSelectedLearningPath] = useState("All Paths")
    ...
    const filteredCourses = useMemo(() => {
        ...
        if (selectedLearningPath !== "All Paths") {
            filtered = filtered.filter(course => course.learningPath === selectedLearningPath)
        }
        ...
        return filtered
    }, [searchQuery, selectedCategory, selectedLevel, selectedLearningPath, priceFilter, sortBy])
