                ...
                <div className="flex items-start gap-8">
                  ...
                  <div className="relative group">
                    <Avatar className="w-32 h-32 border-1 border-blue-200/30 group-hover:border-blue-500/50 transition-colors cursor-pointer rounded-full overflow-hidden bg-gradient-to-br from-blue-200 to-blue-400 p-1">
                      ...
                      <AvatarFallback className="bg-gradient-to-br from-blue-50 to-blue-100 text-blue-600 font-semibold text-4xl flex items-center justify-center w-full h-full">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <Input
                          ...
                          className="mt-2 bg-white/60 border-blue-200/50 focus:border-blue-400"
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <Input
                            ...
                            className="mt-2 pl-10 pr-24 bg-white/60 border-blue-200/50 focus:border-blue-400"
                            readOnly
                          />
                          {!user?.emailVerified && (
                            <Button
                              ...
                              className="absolute right-2 top-1/2 transform -translate-y-1/2 h-8 px-3 text-xs bg-orange-500 hover:bg-orange-600"
                            >
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-blue-200/30 shadow-lg">
              ...
              <CardContent className="space-y-4">
                {[
                  ...
                  { key: 'courseReminders', label: 'Course Reminders', desc: 'Reminders about your ongoing courses' },
                  { key: 'assignmentDeadlines', label: 'Assignment Deadlines', desc: 'Alerts for upcoming deadlines' },
                  { key: 'weeklyDigest', label: 'Weekly Digest', desc: 'Weekly summary of your progress' },
                  { key: 'studyReminders', label: 'Study Reminders', desc: 'Daily reminders to keep studying' }
                ].map((item) => (
